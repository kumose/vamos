...
public:
  ...
  virtual std::set<vamos::encoding_type>
...
private:
  ...
  std::map<std::string, std::set<vamos::encoding_type>>
      expected_input_encoding;

private:
  void run_validate_utf8(const vamos::implementation &implementation,
                         size_t iterations);
  void
  run_validate_utf8_with_errors(const vamos::implementation &implementation,
                                size_t iterations);
  void run_validate_utf16(const vamos::implementation &implementation,
                          size_t iterations);
  void
  run_validate_utf16_with_errors(const vamos::implementation &implementation,
                                 size_t iterations);
  void run_validate_utf32(const vamos::implementation &implementation,
                          size_t iterations);
  void
  run_validate_utf32_with_errors(const vamos::implementation &implementation,
                                 size_t iterations);
  void run_count_utf8(const vamos::implementation &implementation,
                      size_t iterations);
  void run_count_utf16(const vamos::implementation &implementation,
                       size_t iterations);
  void
  run_utf8_length_from_latin1(const vamos::implementation &implementation,
                              size_t iterations);
  void run_convert_latin1_to_utf8(const vamos::implementation &implementation,
                                  size_t iterations);
  void
  run_convert_latin1_to_utf16(const vamos::implementation &implementation,
                              size_t iterations);
  void
  run_convert_latin1_to_utf32(const vamos::implementation &implementation,
                              size_t iterations);
  void run_convert_utf8_to_latin1(const vamos::implementation &implementation,
                                  size_t iterations);
  void run_convert_utf8_to_latin1_with_errors(
      const vamos::implementation &implementation, size_t iterations);
  void run_convert_utf8_to_utf16(const vamos::implementation &implementation,
                                 size_t iterations);
  void run_convert_utf8_to_utf16_with_errors(
      const vamos::implementation &implementation, size_t iterations);
  void run_convert_utf8_to_utf32(const vamos::implementation &implementation,
                                 size_t iterations);
  ...
  void run_convert_valid_utf8_to_latin1(
      const vamos::implementation &implementation, size_t iterations);
  void
  run_convert_valid_utf8_to_utf16(const vamos::implementation &implementation,
                                  size_t iterations);
  void
  run_convert_valid_utf8_to_utf32(const vamos::implementation &implementation,
                                  size_t iterations);
  void
  run_convert_utf16_to_latin1(const vamos::implementation &implementation,
                              size_t iterations);
  void run_convert_utf16_to_latin1_with_errors(
      const vamos::implementation &implementation, size_t iterations);
  void run_convert_utf16_to_utf8(const vamos::implementation &implementation,
                                 size_t iterations);
  void run_convert_utf16_to_utf8_with_errors(
      const vamos::implementation &implementation, size_t iterations);
  void run_convert_utf16_to_utf32(const vamos::implementation &implementation,
                                  size_t iterations);
  ...
  void run_convert_valid_utf16_to_latin1(
      const vamos::implementation &implementation, size_t iterations);
  void
  run_convert_valid_utf16_to_utf8(const vamos::implementation &implementation,
                                  size_t iterations);
  void
  run_convert_utf32_to_latin1(const vamos::implementation &implementation,
                              size_t iterations);
  void run_convert_utf32_to_latin1_with_errors(
      const vamos::implementation &implementation, size_t iterations);
  void run_convert_utf32_to_utf8(const vamos::implementation &implementation,
                                 size_t iterations);
  ...
  void run_convert_valid_utf32_to_latin1(
      const vamos::implementation &implementation, size_t iterations);
  void
  run_convert_valid_utf32_to_utf8(const vamos::implementation &implementation,
                                  size_t iterations);
  void run_convert_utf32_to_utf16(const vamos::implementation &implementation,
                                  size_t iterations);
  ...
  void run_convert_valid_utf16_to_utf32(
      const vamos::implementation &implementation, size_t iterations);
  void run_detect_encodings(const vamos::implementation &implementation,
                            size_t iterations);
