...
//
#ifndef VAMOS_HASWELL_IMPLEMENTATION_H
#define VAMOS_HASWELL_IMPLEMENTATION_H
...
public:
  vamos_really_inline implementation()
      : vamos::implementation("haswell", "Intel/AMD AVX2",
...
#endif // VAMOS_HASWELL_IMPLEMENTATION_H
