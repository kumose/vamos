...
struct base16 : base<simd16<T>> {
  ...
  vamos_really_inline base16(const __m256i _value)
  ...
  friend vamos_always_inline Mask operator==(const simd16<T> lhs,
                                               const simd16<T> rhs) {
...
template <> struct simd16<bool> : base16<bool> {
  ...
  vamos_really_inline simd16(const __m256i _value) : base16<bool>(_value) {}
  // Splat constructor
  vamos_really_inline simd16(bool _value) : base16<bool>(splat(_value)) {}

  vamos_really_inline bitmask_type to_bitmask() const {
...
template <typename T> struct base16_numeric : base16<T> {
  ...
  static vamos_really_inline simd16<T> zero() {
  ...
  vamos_really_inline base16_numeric(const __m256i _value)
      : base16<T>(_value) {}
  ...
  vamos_really_inline simd16<T> operator~() const { return *this ^ 0xFFFFu; }
...
template <> struct simd16<int16_t> : base16_numeric<int16_t> {
  ...
  vamos_really_inline simd16(const __m256i _value)
...
template <typename T> struct simd16x32 {
  ...
  vamos_really_inline simd16x32(const simd16<T> chunk0,
  ...
  vamos_really_inline simd16x32<T> bit_or(const T m) const {
