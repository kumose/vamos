...
//
#ifndef VAMOS_HASWELL_BITMANIPULATION_H
#define VAMOS_HASWELL_BITMANIPULATION_H
...
vamos_inline int trailing_zeroes(uint64_t input_num) {
...
#endif // VAMOS_HASWELL_BITMANIPULATION_H
