...
template <typename T, typename Mask = simd16<bool>> struct base_u16 {
  ...
  vamos_really_inline base_u16(const __m128i _value) : value(_value) {}
  // Bit operations
...
struct base16 : base_u16<T> {
  ...
  vamos_really_inline base16(const __m128i _value) : base_u16<T>(_value) {}
...
template <typename T> struct base16_numeric : base16<T> {
  ...
  static vamos_really_inline simd16<T> zero() { return __lsx_vldi(0); }
...
template <> struct simd16<int16_t> : base16_numeric<int16_t> {
  ...
  vamos_really_inline simd16(simd16<bool> other)
