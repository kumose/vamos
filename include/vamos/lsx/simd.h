...
//
#ifndef VAMOS_LSX_SIMD_H
#define VAMOS_LSX_SIMD_H
...
template <typename T, typename Mask = simd8<bool>> struct base_u8 {
  ...
  vamos_really_inline base_u8(const __m128i _value) : value(_value) {}
...
template <> struct simd8<bool> : base_u8<bool> {
  ...
  vamos_really_inline simd8(const __m128i _value) : base_u8<bool>(_value) {}
  // False constructor
  vamos_really_inline simd8() : simd8(__lsx_vldi(0)) {}
  // Splat constructor
...
template <> struct simd8<uint8_t> : base_u8<uint8_t> {
  ...
  static vamos_really_inline simd8<uint8_t> zero() { return __lsx_vldi(0); }
...
template <> struct simd8<int8_t> {
  ...
  static vamos_really_inline simd8<int8_t> zero() { return __lsx_vldi(0); }
  ...
  // Conversion from/to SIMD register
  vamos_really_inline simd8(const __m128i _value) : value(_value) {}
  vamos_really_inline operator const __m128i &() const { return this->value; }
...
#include <vamos/lsx/simd16-inl.h>
} // namespace simd
} // unnamed namespace
} // namespace VAMOS_IMPLEMENTATION
} // namespace vamos

#endif // VAMOS_LSX_SIMD_H
