...
//
#ifndef VAMOS_ARM64_SIMD_H
#define VAMOS_ARM64_SIMD_H
...
namespace {
  ...
  #ifndef vamos_make_uint8x16_t
    #define vamos_make_uint8x16_t(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10,   \
  ...
  #endif
  #ifndef vamos_make_int8x16_t
    #define vamos_make_int8x16_t(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10,    \
                                   x11, x12, x13, x14, x15, x16)               \
      ([=]() {                                                                 \
  ...
  #ifndef vamos_make_uint8x8_t
    #define vamos_make_uint8x8_t(x1, x2, x3, x4, x5, x6, x7, x8)             \
      ([=]() {                                                                 \
        uint8_t array[8] = {x1, x2, x3, x4, x5, x6, x7, x8};                   \
        return vld1_u8(array);                                                 \
      }())
  #endif
  #ifndef vamos_make_int8x8_t
    #define vamos_make_int8x8_t(x1, x2, x3, x4, x5, x6, x7, x8)              \
      ([=]() {                                                                 \
        int8_t array[8] = {x1, x2, x3, x4, x5, x6, x7, x8};                    \
        return vld1_s8(array);                                                 \
      }())
  #endif
  #ifndef vamos_make_uint16x8_t
    #define vamos_make_uint16x8_t(x1, x2, x3, x4, x5, x6, x7, x8)            \
      ([=]() {                                                                 \
        uint16_t array[8] = {x1, x2, x3, x4, x5, x6, x7, x8};                  \
        return vld1q_u16(array);                                               \
      }())
  #endif
  #ifndef vamos_make_int16x8_t
    #define vamos_make_int16x8_t(x1, x2, x3, x4, x5, x6, x7, x8)             \
      ([=]() {                                                                 \
...
template <typename T, typename Mask = simd8<bool>> struct base_u8 {
  ...
  vamos_really_inline base_u8(const uint8x16_t _value) : value(_value) {}
  vamos_really_inline operator const uint8x16_t &() const {
    return this->value;
  }
  vamos_really_inline operator uint8x16_t &() { return this->value; }
  vamos_really_inline T first() const { return vgetq_lane_u8(*this, 0); }
  vamos_really_inline T last() const { return vgetq_lane_u8(*this, 15); }

  // Bit operations
  vamos_really_inline simd8<T> operator|(const simd8<T> other) const {
  ...
  vamos_really_inline simd8<T> bit_andnot(const simd8<T> other) const {
    return vbicq_u8(*this, other);
  }
  vamos_really_inline simd8<T> operator~() const { return *this ^ 0xFFu; }
  vamos_really_inline simd8<T> &operator|=(const simd8<T> other) {
  ...
  friend vamos_really_inline Mask operator==(const simd8<T> lhs,
                                               const simd8<T> rhs) {
    return vceqq_u8(lhs, rhs);
  }

  template <int N = 1>
  vamos_really_inline simd8<T> prev(const simd8<T> prev_chunk) const {
...
template <> struct simd8<bool> : base_u8<bool> {
  ...
  static vamos_really_inline simd8<bool> splat(bool _value) {
    return vmovq_n_u8(uint8_t(-(!!_value)));
  }

  vamos_really_inline simd8(const uint8x16_t _value)
      : base_u8<bool>(_value) {}
  // False constructor
  vamos_really_inline simd8() : simd8(vdupq_n_u8(0)) {}
  // Splat constructor
  vamos_really_inline simd8(bool _value) : simd8(splat(_value)) {}
  vamos_really_inline void store(uint8_t dst[16]) const {
  ...
  // in some compilers).
  vamos_really_inline uint32_t to_bitmask() const {
#ifdef VAMOS_REGULAR_VISUAL_STUDIO
    const uint8x16_t bit_mask =
        vamos_make_uint8x16_t(0x01, 0x02, 0x4, 0x8, 0x10, 0x20, 0x40, 0x80,
  ...
  vamos_really_inline uint64_t to_bitmask64() const {
    return vget_lane_u64(
        vreinterpret_u64_u8(vshrn_n_u16(vreinterpretq_u16_u8(*this), 4)), 0);
  }

  vamos_really_inline bool any() const {
    return vmaxvq_u32(vreinterpretq_u32_u8(*this)) != 0;
  }
  vamos_really_inline bool none() const {
    return vmaxvq_u32(vreinterpretq_u32_u8(*this)) == 0;
  }
  vamos_really_inline bool all() const {
...
template <> struct simd8<uint8_t> : base_u8<uint8_t> {
  static vamos_really_inline simd8<uint8_t> splat(uint8_t _value) {
    return vmovq_n_u8(_value);
  }
  static vamos_really_inline simd8<uint8_t> zero() { return vdupq_n_u8(0); }
  static vamos_really_inline simd8<uint8_t> load(const uint8_t *values) {
    return vld1q_u8(values);
  }
  vamos_really_inline simd8(const uint8x16_t _value)
      : base_u8<uint8_t>(_value) {}
  // Zero constructor
  vamos_really_inline simd8() : simd8(zero()) {}
  // Array constructor
  vamos_really_inline simd8(const uint8_t values[16]) : simd8(load(values)) {}
  // Splat constructor
  vamos_really_inline simd8(uint8_t _value) : simd8(splat(_value)) {}
  ...
  simd8(uint8_t v0, uint8_t v1, uint8_t v2, uint8_t v3, uint8_t v4, uint8_t v5,
      ...
      : simd8(vamos_make_uint8x16_t(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9,
  ...
  vamos_really_inline static simd8<uint8_t>
  ...
  // Saturated math
  vamos_really_inline simd8<uint8_t>
  ...
  vamos_really_inline simd8<uint8_t> &operator+=(const simd8<uint8_t> other) {
    *this = *this + other;
    return *this;
  }
  vamos_really_inline simd8<uint8_t> &operator-=(const simd8<uint8_t> other) {
  ...
  vamos_really_inline uint8_t max_val() const { return vmaxvq_u8(*this); }
  vamos_really_inline uint8_t min_val() const { return vminvq_u8(*this); }
  vamos_really_inline simd8<uint8_t>
  ...
  vamos_really_inline simd8<bool>
  operator<=(const simd8<uint8_t> other) const {
  ...
  vamos_really_inline simd8<bool> any_bits_set(simd8<uint8_t> bits) const {
    return vtstq_u8(*this, bits);
  }
  vamos_really_inline bool is_ascii() const {
    return this->max_val() < 0b10000000u;
  }

  vamos_really_inline bool any_bits_set_anywhere() const {
    return this->max_val() != 0;
  }
  vamos_really_inline bool any_bits_set_anywhere(simd8<uint8_t> bits) const {
    return (*this & bits).any_bits_set_anywhere();
  }
  template <int N> vamos_really_inline simd8<uint8_t> shr() const {
    return vshrq_n_u8(*this, N);
  }
  template <int N> vamos_really_inline simd8<uint8_t> shl() const {
  ...
  template <typename L>
  vamos_really_inline simd8<L> lookup_16(simd8<L> lookup_table) const {
    return lookup_table.apply_lookup_16_to(*this);
  }

  template <typename L>
  vamos_really_inline simd8<L>
...
template <> struct simd8<int8_t> {
  ...
  static vamos_really_inline simd8<int8_t> splat(int8_t _value) {
    return vmovq_n_s8(_value);
  }
  static vamos_really_inline simd8<int8_t> zero() { return vdupq_n_s8(0); }
  static vamos_really_inline simd8<int8_t> load(const int8_t values[16]) {
  ...
  vamos_really_inline void store_ascii_as_utf16(char16_t *p) const {
  ...
  vamos_really_inline void store_ascii_as_utf32(char32_t *p) const {
  ...
  // In places where the table can be reused, which is most uses in vamos, it
  // is worth it to do 4 table lookups, as there is no direct zero extension
  // from u8 to u32.
  vamos_really_inline void store_ascii_as_utf32_tbl(char32_t *p) const {
  ...
  // Conversion from/to SIMD register
  vamos_really_inline simd8(const int8x16_t _value) : value{_value} {}
  vamos_really_inline operator const int8x16_t &() const {
    return this->value;
  }
#ifndef VAMOS_REGULAR_VISUAL_STUDIO
  vamos_really_inline operator const uint8x16_t() const {
    return vreinterpretq_u8_s8(this->value);
  }
#endif
  vamos_really_inline operator int8x16_t &() { return this->value; }

  // Zero constructor
  vamos_really_inline simd8() : simd8(zero()) {}
  // Splat constructor
  vamos_really_inline simd8(int8_t _value) : simd8(splat(_value)) {}
  // Array constructor
  vamos_really_inline simd8(const int8_t *values) : simd8(load(values)) {}
  // Member-by-member initialization
#ifdef VAMOS_REGULAR_VISUAL_STUDIO
  vamos_really_inline simd8(int8_t v0, int8_t v1, int8_t v2, int8_t v3,
                              int8_t v4, int8_t v5, int8_t v6, int8_t v7,
                              int8_t v8, int8_t v9, int8_t v10, int8_t v11,
                              int8_t v12, int8_t v13, int8_t v14, int8_t v15)
      : simd8(vamos_make_int8x16_t(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9,
                                     v10, v11, v12, v13, v14, v15)) {}
#else
  vamos_really_inline simd8(int8_t v0, int8_t v1, int8_t v2, int8_t v3,
                              int8_t v4, int8_t v5, int8_t v6, int8_t v7,
...
#endif
  // Repeat 16 values as many times as necessary (usually for lookup tables)
  vamos_really_inline static simd8<int8_t>
  ...
  // Store to array
  vamos_really_inline void store(int8_t dst[16]) const {
...
#ifndef VAMOS_REGULAR_VISUAL_STUDIO
  vamos_really_inline explicit simd8(const uint8x16_t other)
      : simd8(vreinterpretq_s8_u8(other)) {}
#endif
  vamos_really_inline operator simd8<uint8_t>() const {
    return vreinterpretq_u8_s8(this->value);
  }

  vamos_really_inline simd8<int8_t>
  ...
  vamos_really_inline simd8<int8_t> &operator+=(const simd8<int8_t> other) {
    *this = *this + other;
    return *this;
  }
  vamos_really_inline simd8<int8_t> &operator-=(const simd8<int8_t> other) {
  ...
  vamos_really_inline int8_t max_val() const { return vmaxvq_s8(value); }
  vamos_really_inline int8_t min_val() const { return vminvq_s8(value); }
  vamos_really_inline bool is_ascii() const { return this->min_val() >= 0; }

  // Order-sensitive comparisons
  vamos_really_inline simd8<int8_t> max_val(const simd8<int8_t> other) const {
    return vmaxq_s8(value, other.value);
  }
  vamos_really_inline simd8<int8_t> min_val(const simd8<int8_t> other) const {
    return vminq_s8(value, other.value);
  }
  vamos_really_inline simd8<bool> operator>(const simd8<int8_t> other) const {
...
template <typename T> struct simd8x64 {
  ...
  vamos_really_inline simd8x64(const simd8<T> chunk0, const simd8<T> chunk1,
                                 const simd8<T> chunk2, const simd8<T> chunk3)
      : chunks{chunk0, chunk1, chunk2, chunk3} {}
  vamos_really_inline simd8x64(const T *ptr)
  ...
  vamos_really_inline void store(T *ptr) const {
  ...
  vamos_really_inline simd8x64<T> &operator|=(const simd8x64<T> &other) {
  ...
  vamos_really_inline simd8<T> reduce_or() const {
    return (this->chunks[0] | this->chunks[1]) |
           (this->chunks[2] | this->chunks[3]);
  }

  vamos_really_inline bool is_ascii() const { return reduce_or().is_ascii(); }

  template <endianness endian>
  vamos_really_inline void store_ascii_as_utf16(char16_t *ptr) const {
  ...
  vamos_really_inline void store_ascii_as_utf32(char32_t *ptr) const {
  ...
  vamos_really_inline uint64_t to_bitmask() const {
#ifdef VAMOS_REGULAR_VISUAL_STUDIO
    const uint8x16_t bit_mask =
        vamos_make_uint8x16_t(0x01, 0x02, 0x4, 0x8, 0x10, 0x20, 0x40, 0x80,
                                0x01, 0x02, 0x4, 0x8, 0x10, 0x20, 0x40, 0x80);
  ...
  vamos_really_inline uint64_t eq(const T m) const {
  ...
  vamos_really_inline uint64_t lteq(const T m) const {
    const simd8<T> mask = simd8<T>::splat(m);
    return simd8x64<bool>(this->chunks[0] <= mask, this->chunks[1] <= mask,
                          this->chunks[2] <= mask, this->chunks[3] <= mask)
        .to_bitmask();
  ...
  vamos_really_inline uint64_t in_range(const T low, const T high) const {
  ...
  vamos_really_inline uint64_t not_in_range(const T low, const T high) const {
    const simd8<T> mask_low = simd8<T>::splat(low);
    const simd8<T> mask_high = simd8<T>::splat(high);
    return simd8x64<bool>(
               (this->chunks[0] > mask_high) | (this->chunks[0] < mask_low),
  ...
  vamos_really_inline uint64_t lt(const T m) const {
    const simd8<T> mask = simd8<T>::splat(m);
    return simd8x64<bool>(this->chunks[0] < mask, this->chunks[1] < mask,
                          this->chunks[2] < mask, this->chunks[3] < mask)
        .to_bitmask();
  }
  vamos_really_inline uint64_t gt(const T m) const {
    const simd8<T> mask = simd8<T>::splat(m);
    return simd8x64<bool>(this->chunks[0] > mask, this->chunks[1] > mask,
                          this->chunks[2] > mask, this->chunks[3] > mask)
        .to_bitmask();
  }
  vamos_really_inline uint64_t gteq(const T m) const {
    const simd8<T> mask = simd8<T>::splat(m);
    return simd8x64<bool>(this->chunks[0] >= mask, this->chunks[1] >= mask,
                          this->chunks[2] >= mask, this->chunks[3] >= mask)
        .to_bitmask();
  }
  vamos_really_inline uint64_t gteq_unsigned(const uint8_t m) const {
...
#include <vamos/arm64/simd16-inl.h>
} // namespace simd
} // unnamed namespace
} // namespace VAMOS_IMPLEMENTATION
} // namespace vamos

#endif // VAMOS_ARM64_SIMD_H
