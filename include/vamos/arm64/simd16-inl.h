...
template <typename T, typename Mask = simd16<bool>> struct base_u16 {
  ...
  vamos_really_inline base_u16() = default;
  vamos_really_inline base_u16(const uint16x8_t _value) : value(_value) {}
  vamos_really_inline operator const uint16x8_t &() const {
    return this->value;
  }
  vamos_really_inline operator uint16x8_t &() { return this->value; }
  // Bit operations
  ...
  vamos_really_inline simd16<T> bit_andnot(const simd16<T> other) const {
...
struct base16 : base_u16<T> {
  ...
  vamos_really_inline base16() : base_u16<T>() {}
  vamos_really_inline base16(const uint16x8_t _value) : base_u16<T>(_value) {}
  template <typename Pointer>
  vamos_really_inline base16(const Pointer *ptr) : base16(vld1q_u16(ptr)) {}
...
template <> struct simd16<bool> : base16<bool> {
  ...
  vamos_really_inline simd16(const uint16x8_t _value)
      : base16<bool>(_value) {}
  // Splat constructor
...
template <typename T> struct base16_numeric : base16<T> {
  ...
  static vamos_really_inline simd16<T> zero() { return vdupq_n_u16(0); }
  ...
  vamos_really_inline base16_numeric(const uint16x8_t _value)
      : base16<T>(_value) {}
...
template <> struct simd16<int16_t> : base16_numeric<int16_t> {
...
#endif
  vamos_really_inline simd16(const int16x8_t _value)
  ...
  vamos_really_inline operator const int16x8_t() const {
    return vreinterpretq_s16_u16(this->value);
  }

  vamos_really_inline int16_t max_val() const {
    return vmaxvq_s16(vreinterpretq_s16_u16(this->value));
  }
  vamos_really_inline int16_t min_val() const {
...
template <> struct simd16<uint16_t> : base16_numeric<uint16_t> {
  ...
  vamos_really_inline int16_t max_val() const { return vmaxvq_u16(*this); }
  vamos_really_inline int16_t min_val() const { return vminvq_u16(*this); }
  // Saturated math
...
template <>
vamos_really_inline uint64_t simd16x32<uint16_t>::not_in_range(
