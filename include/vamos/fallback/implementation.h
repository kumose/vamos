...
//
#ifndef VAMOS_FALLBACK_IMPLEMENTATION_H
#define VAMOS_FALLBACK_IMPLEMENTATION_H
...
public:
  vamos_really_inline implementation()
      : vamos::implementation("fallback", "Generic fallback implementation",
                                0) {}
...
#endif // VAMOS_FALLBACK_IMPLEMENTATION_H
