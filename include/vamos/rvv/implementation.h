...
//
#ifndef VAMOS_RVV_IMPLEMENTATION_H
#define VAMOS_RVV_IMPLEMENTATION_H
...
public:
  vamos_really_inline implementation()
      : vamos::implementation("rvv", "RISC-V Vector Extension",
...
#elif VAMOS_HAS_ZVBB_INTRINSICS
...
#endif // VAMOS_RVV_IMPLEMENTATION_H
