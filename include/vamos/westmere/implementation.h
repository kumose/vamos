...
//
#ifndef VAMOS_WESTMERE_IMPLEMENTATION_H
#define VAMOS_WESTMERE_IMPLEMENTATION_H
...
public:
  vamos_really_inline implementation()
      : vamos::implementation("westmere", "Intel/AMD SSE4.2",
...
#endif // VAMOS_WESTMERE_IMPLEMENTATION_H
