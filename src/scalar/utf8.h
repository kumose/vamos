...
namespace {
namespace utf8 {
#if VAMOS_IMPLEMENTATION_FALLBACK || VAMOS_IMPLEMENTATION_RVV
...
// the stream (start).
inline vamos_warn_unused result rewind_and_validate_with_errors(
...
vamos_warn_unused inline size_t trim_partial_utf8(const char *input,
                                                    size_t length) {
  if (length < 3) {
    switch (length) {
    case 2:
