...
/*
    This upcoming macro (VAMOS_ICELAKE_TRANSCODE16) takes 16 + 4 bytes (of a
...
#define VAMOS_ICELAKE_TRANSCODE16(LANE0, LANE1, MASKED)                      \
  {                                                                            \
...
#define VAMOS_ICELAKE_WRITE_UTF16_OR_UTF32(INPUT, VALID_COUNT, MASKED)       \
  {                                                                            \
    if (UTF32) {                                                               \
      if (MASKED) {                                                            \
...
#define VAMOS_ICELAKE_STORE_ASCII(UTF32, utf8, output)                       \
  if (UTF32) {                                                                 \
