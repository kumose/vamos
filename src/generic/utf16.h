...
vamos_really_inline size_t count_code_points(const char16_t *in,
                                               size_t size) {
  size_t pos = 0;
  size_t count = 0;
...
template <endianness big_endian>
vamos_really_inline size_t utf8_length_from_utf16(const char16_t *in,
                                                    size_t size) {
  size_t pos = 0;
  size_t count = 0;
...
template <endianness big_endian>
vamos_really_inline size_t utf32_length_from_utf16(const char16_t *in,
                                                     size_t size) {
